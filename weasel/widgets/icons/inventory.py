...
arrow_in = os.path.join(fugue_icons, 'arrow-in.png')
arrow_out = os.path.join(fugue_icons, 'arrow-out.png')
...
highlighter_minus = os.path.join(fugue_icons, 'highlighter--minus.png')
highlighter_plus = os.path.join(fugue_icons, 'highlighter--plus.png')
...
paint = os.path.join(fugue_icons, 'paint.png')
paint_can_minus = os.path.join(fugue_icons, 'paint-can--minus.png')
paint_brush = os.path.join(fugue_icons, 'paint-brush.png')
paint_brush_plus = os.path.join(fugue_icons, 'paint-brush--plus.png')
paint_brush_minus = os.path.join(fugue_icons, 'paint-brush--minus.png')
...
wand = os.path.join(fugue_icons, 'wand.png')
wand_hat = os.path.join(fugue_icons, 'wand_hat.png')