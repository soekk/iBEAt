"""This is the old versions of the macros script

Retaining this as a basis for a future working implementation with updated elements.
"""
...
# import rename (new version)
# import ndr (new version)
# import modelling (new version)



def _mdreg_macro(app):
...
def _mdreg_macro_no_import(app):
